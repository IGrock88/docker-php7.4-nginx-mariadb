...
CMD ["java", "-Dfile.encoding=UTF-8", "-Xms4096m", "-Xmx4096m", "-DdriverPath=/var/java/app/src/main/resources/libfptr10.so", "-jar", "CheckPrinter-1.0-jar-with-dependencies.jar"]
